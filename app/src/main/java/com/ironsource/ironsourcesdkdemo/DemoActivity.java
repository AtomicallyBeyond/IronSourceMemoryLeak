...
public class DemoActivity extends AppCompatActivity implements RewardedVideoListener, OfferwallListener, InterstitialListener, ImpressionDataListener {
    ...
    private Button mCloseBannerButton;
    private BannerFragment currentBannerFragment;
    ...
    private void initUIElements() {
        ...
        mLoadBannerButton = findViewById(R.id.load_banner_button);
        mLoadBannerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                currentBannerFragment = BannerFragment.newInstance();
                getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, currentBannerFragment).commit();
            }
        });

        mCloseBannerButton = findViewById(R.id.close_banner_button);
        mCloseBannerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getSupportFragmentManager().beginTransaction().remove(currentBannerFragment).commit();
            }
        });
